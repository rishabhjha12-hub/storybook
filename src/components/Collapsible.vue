<template>
  <div class="w-[350px] space-y-2">
    <div class="flex items-center">
      ...
      <button
        class="text-blue-500 hover:text-blue-700 focus:outline-none px-4"
        @click="isOpen = !isOpen"
    ...
    <div class="rounded-md border px-6 py-4 font-mono text-sm m-2">
      tglide/radix-svelte
    </div>
...
/* Increase the size of the collapsed item box */
.rounded-md.border.px-6.py-4 {
  padding: 12px 24px;
}
</style>
